...
public class Gizmo extends Component{
    ...
    private Vector2f yAxisOffset = new Vector2f(15, 61);
    ...
    public Gizmo(Sprite arrowSprite, PropertiesWindow propertiesWindow) {
        ...
        this.xAxisObject.name = "xAxis";
        this.yAxisObject.name = "yAxis";

        this.xAxisObject.transform.zIndex = 15;
        this.yAxisObject.transform.zIndex = 15;
